...
export type PlatformProfile = {
    readonly tag: "dreamcast";
    readonly val: MemorySize;
} | {
    readonly tag: "psp";
    readonly val: MemorySize;
} | {
    ...
    readonly tag: "v6r-small";
    readonly val: MemorySize;
} | {
    readonly tag: "v6r-medium";
    readonly val: MemorySize;
} | {
    readonly tag: "v6r-large";
    readonly val: MemorySize;
} | {
    readonly tag: "custom";
    readonly val: MemorySize;
...
export declare enum MemoryPurpose {
    VmHeap = "vm-heap",
...
export declare enum MemoryPressure {
    Low = "low",
    Medium = "medium",
    High = "high",
    Critical = "critical"
